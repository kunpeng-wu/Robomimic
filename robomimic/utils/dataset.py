...
class SequenceDataset(torch.utils.data.Dataset):
    def __init__(
        ...
        Args:
            ...
            goal_mode (str or None): either "last" or None. Defaults to None, which is to not fetch goals
            ...
            filter_by_attribute (str or None): if provided, use the provided filter key to look up a subset of
