...
def initialize_obs_utils_with_obs_specs(obs_modality_specs):
    ...
    for obs_modality_spec in obs_modality_spec_list:
        ...
        for obs_modalities in obs_modality_spec.values():   # low_dim
            for obs_modality, obs_keys in obs_modalities.items():   # low_dim, [robot0_eef_qpos, robot0_eef_quat, robot0_gripper_qpos, object]
                ...
                obs_modality_mapping[obs_modality] += obs_keys  # {'low_dim': [robot0_eef_qpos, robot0_eef_quat, robot0_gripper_qpos, object]}
                # loop over each modality, and add to global dict if it doesn't exist yet
                for obs_key in obs_keys:
                    if obs_key not in OBS_KEYS_TO_MODALITIES:
                        OBS_KEYS_TO_MODALITIES[obs_key] = obs_modality  # {'robot0_eef_qpos': 'low_dim', 'robot0_eef_quat': 'low_dim', ...}
    ...
    # {'low_dim': [robot0_eef_qpos, robot0_eef_quat, robot0_gripper_qpos, object], 'rgb': []}
