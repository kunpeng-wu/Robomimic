...
if __name__ == "__main__":
    ...
    dataset_path = "/home/kavin/Documents/PycharmProjects/Robomimic/datasets/lift/humanoid/low_dim.hdf5"
    # set torch device
    ...
    # batch = next(data_loader_iter)
    # print_batch_info(batch)
    # print(batch["obs"]["robot0_eef_pos"].shape)  # torch.Size([100, 10, 3])
    # print(batch["obs"]["robot0_eef_quat"].shape)  # torch.Size([100, 10, 4])
    # print(batch["obs"]["robot0_gripper_qpos"].shape)  # torch.Size([100, 10, 2])
    # print(batch["obs"]["object"].shape)  # torch.Size([100, 10, 10])
    # run train loop
